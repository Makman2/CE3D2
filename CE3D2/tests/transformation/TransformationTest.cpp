...
BOOST_AUTO_TEST_CASE(test_transform)
{
    ...
    test_vector_list.push_back(CE3D2_CREATE_VECTOR(0.0f, 1.0f));
    test_vector_list.push_back(CE3D2_CREATE_VECTOR(-10.2f));
    ...
    // calculation.
    compare_vector_list.push_back(CE3D2_CREATE_VECTOR(3 * 1.2f, -6.0f, 36.9f));
    compare_vector_list.push_back(CE3D2_CREATE_VECTOR(0.0f, 3.0f));
    compare_vector_list.push_back(CE3D2_CREATE_VECTOR(-30.6f));
