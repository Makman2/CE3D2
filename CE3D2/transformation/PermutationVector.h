...
namespace Transformation
{
    ...
    /// @returns  A 1-dimensional permutation vector.
    PermutationVector
    ...
    /// @returns  A 2-dimensional permutation vector.
    PermutationVector
    ...
    /// @returns  A 3-dimensional permutation vector.
    PermutationVector
    ...
    /// @returns  A 4-dimensional permutation vector.
    PermutationVector
    ...
    /// @returns  A 5-dimensional permutation vector.
    PermutationVector
    create_permutation_vector(size_t v0,
                              size_t v1,
                              size_t v2,
